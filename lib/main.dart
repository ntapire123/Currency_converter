...
class _CurrencyConverterAppState extends State<CurrencyConverterApp> {
  ...
  final List<String> _currencies = ['USD', 'EUR', 'GBP', 'JPY', 'CAD', 'AUD','NEP'];
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Exchange Rate: 1 $_fromCurrency = ${(_hardcodedRates[_toCurrency]! / _hardcodedRates[_fromCurrency]!).toStringAsFixed(4)} $_toCurrency',
